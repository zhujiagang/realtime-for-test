...
parser.add_argument('--input_type', default='brox', type=str, help='INput tyep default rgb can take flow as well')
...
parser.add_argument('--save_root', default='/data4/lilin/my_code/realtime/saveucf24/', help='Location to save checkpoint models')
parser.add_argument('--iou_thresh', default=0.75, type=float, help='Evaluation threshold')
...
def te_net(net, save_root, exp_name, input_type, dataset, iteration, num_classes, thresh=0.5 ):
...
def main():
    ...
    trained_model_path = "/data4/lilin/my_code/realtime/ucf24/brox-ssd300_ucf24_120000.pth"
    ...
    mAP, ap_all, ap_strs = te_net(net, args.save_root, exp_name, args.input_type, dataset, iteration, num_classes, args.iou_thresh)
